...
urban_vs_rural = ai_summary[
    ai_summary['State'].isin(urban_states + rural_states)
].sort_values(by='Median Salary ($)', ascending=False)

plt.figure(figsize=(10, 6))
plt.bar(urban_vs_rural['State'], urban_vs_rural['Median Salary ($)'], color='darkorange')
plt.xlabel("State")
